 ...
 */
final class Version20220316084458 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis CHANGE nom nom VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE email email VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE message message LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE fichier CHANGE nom_original nom_original VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nom_serveur nom_serveur VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE extension extension VARCHAR(3) NOT NULL COLLATE `utf8mb4_unicode_ci`');
